...
public class C2505C extends RadioButton implements InterfaceC0444r, InterfaceC0445s {

    /* renamed from: a */
    public final C0900d f8191a;

    /* renamed from: b */
    public final C2597p f8192b;

    /* renamed from: c */
    public final C2553a0 f8193c;

    /* renamed from: d */
    public C2618w f8194d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2505C(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.radioButtonStyle);
        AbstractC2581j1.m5035a(context);
        AbstractC2578i1.m5030a(this, getContext());
        C0900d c0900d = new C0900d(this);
        this.f8191a = c0900d;
        c0900d.m2430d(attributeSet, R.attr.radioButtonStyle);
        C2597p c2597p = new C2597p(this);
        this.f8192b = c2597p;
        c2597p.m5058d(attributeSet, R.attr.radioButtonStyle);
        C2553a0 c2553a0 = new C2553a0(this);
        this.f8193c = c2553a0;
        c2553a0.m5006f(attributeSet, R.attr.radioButtonStyle);
        getEmojiTextViewHelper().m5085b(attributeSet, R.attr.radioButtonStyle);
    }

    private C2618w getEmojiTextViewHelper() {
        if (this.f8194d == null) {
            this.f8194d = new C2618w(this);
        }
        return this.f8194d;
    }
    ...
    public final void drawableStateChanged() {
        ...
        C2597p c2597p = this.f8192b;
        if (c2597p != null) {
            c2597p.m5055a();
        }
        C2553a0 c2553a0 = this.f8193c;
        if (c2553a0 != null) {
            c2553a0.m5003b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f8193c.m5004d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f8193c.m5005e();
    }
