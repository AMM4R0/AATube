...
public final class C1880gm extends AbstractC2030mm {
    ...
    public final ProtobufStateStorage mo3837a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C2023mf("app_permissions_state", iBinaryDataHelper, new C1069A8(c1785d2, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C1685Z1(new C1363M2()));
    }
