...
public final class C1955jm extends AbstractC2030mm {
    ...
    public final ProtobufStateStorage mo3837a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C2023mf("clids_info", iBinaryDataHelper, new C1069A8(c1687z3, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C1563U3());
    }
